---
layout: post
title: "USCIS case status meanings: what each update actually means"
date: 2026-05-20
author: Granted Team
description: "Every USCIS case status decoded: what each update means, how long the next step takes, and when a status signals a real problem versus normal silence."
---
...
1. **[egov.uscis.gov](https://egov.uscis.gov/casestatus/landing.do)** — the public case status portal. Enter your 13-character receipt number (starts with three letters like MSC, EAC, WAC, LIN, NBC, SRC, IOE) followed by 10 digits. Free, no login.
2. **[my.uscis.gov](https://my.uscis.gov/)** — your USCIS account. More detail than the public portal. Shows previous status changes, notices, biometrics history.
...
1. **Submit an online case inquiry** at [egov.uscis.gov/e-request](https://egov.uscis.gov/e-request) — free, fastest
